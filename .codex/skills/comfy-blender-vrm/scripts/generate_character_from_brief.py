...
from comfy_helpers import GenerationError
...
STRING_FIELDS = {"core_concept", "outfit", "pose", "expression", "background", "extra_notes"}
...
def collect_interactive_brief() -> dict[str, Any]:
    print("generate-character-from-brief")
    print("Enter a short character brief. Press Enter to skip optional fields.")
    ...
    for key, message in (
        ...
        ("pose", "Pose or camera direction (optional): "),
...
def synthesize_character_prompt(brief: dict[str, Any]) -> str:
    prompt_parts: list[str] = [
        brief["core_concept"],
        "full body character concept illustration",
    ...
    try:
        ...
        result = run_character_sheet_generation(
            CharacterSheetRequest(
                ...
                command_name="generate-character-from-brief",

...
from comfy_helpers import (
    ...
    download_file,
    find_repo_root,
    infer_project_name_from_output_path,
    load_config,
    load_workflow_payload,
    post_json,
    prepare_project_output_paths,
    render_template,
    resolve_repo_path,
    save_json,
...
def main() -> int:
    ...
    try:
        ...
        project_name = infer_project_name_from_output_path(base_image_path, output_root) or derive_project_name(
            args.character_prompt,
            args.output_name,
        )
        run_id, run_dir, logs_dir = prepare_project_output_paths(
            output_root,
            project_name,
            "expressions",
            args.output_name,
        ...
        save_json(
            metadata_path,
            {
                "command": "forma-character-generate-expressions",
                "run_id": run_id,
                ...
                "project_output_dir": str(output_root / project_name),
                "base_seed": base_seed,
        ...
        print("forma-character-generate-expressions")
        print(f"Project: {project_name}")
        print(f"Project output: {output_root / project_name}")
        ...
        print("forma-character-generate-expressions failed")
